...
/**
 * Created by Toephy on 2017.4.25 15:29
 */
public class SessionUtil {

    // 本地进制
    private static final String LOCAL_SCALE = "ABCDEFGHIJKLMNOPQRSTUVWXYZ-0123456789_abcdefghijklmnopqrstuvwxyz";
    // 词典映射
    private static final String DICTIONARY = "ehzfInBH4jaDvcU9Y1lpX-O3GQ2VEZ_mKqR6ACWL5xgT0iMrds8SNt7PkbyuowJF";
    ...
    public static void main(String[] args) {
        ...
        SessionInfo sessionInfo1 = SessionUtil.create(202, 1000);
        System.out.println(sessionInfo1);
    }
     ...
     * @return
     */
    public static long getUidBySessionId(String sessionId) {
        SessionInfo sessionInfo = new SessionInfo();
        if (sessionId == null) {
            sessionInfo.setValid(false);
            return -1;
        ...
        if (sessionInfo != null && sessionInfo.isValid() == true && sessionInfo.getUid()> 0) {
            return sessionInfo.getUid();
        }
        return -1;
    }
}
