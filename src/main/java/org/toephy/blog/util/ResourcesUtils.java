...
public class ResourcesUtils extends Object {
     ...
     * @return The resource
     */
    public static Properties getResourceAsProperties(String resource, String charset) throws IOException {
        Properties props = new Properties();
        String propfile = resource;
        Reader reader = new InputStreamReader(getResourceAsStream(propfile), charset);
        props.load(reader);
        reader.close();
        return props;
    }
